...
After generating docs, open `docs/index.html` in a browser.

## How to Play (Tabula)

- Goal: bear off all your pieces before your opponent.
- Turn flow: roll dice, make legal moves, end turn when done.
- If you have pieces on the bar, re-enter them before moving other pieces.

Glossary:

- bar: a holding area for captured pieces waiting to re-enter.
- bear off: remove a piece from the board once all your pieces are in your home board.

## References

- Wikipedia: Tabula (board game)
  https://en.wikipedia.org/wiki/Tabula_%28game%29
- GNU Backgammon manual (general backgammon rule reference)
...
## Acknowledgement
I acknowledge the use of GitHub Copilot during the debugging phase to improve error diagnosis and fix turnaround, specifically for identifying likely root causes of failing tests and verifying that tests fail clearly under intentionally broken behavior. I confirm that the submitted work is my own and that I reviewed and adapted all AI-assisted output before inclusion.
